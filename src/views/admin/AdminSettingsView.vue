  ...
  <AdminShell active="configuracion" title="Configuración de Cuota" subtitle="Monto mensual para socios del CCISJ">
    <div class="fee-settings">
      <section class="fee-panel fee-current">
        <div class="fee-current__intro"><h2>Monto de cuota vigente</h2><p>Definí el valor mensual de la cuota social. Este monto se aplicará automáticamente a todas las empresas activas al momento de generar la facturación.</p></div>
